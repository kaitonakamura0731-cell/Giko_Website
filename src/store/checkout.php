                        ...
                        <div class="bg-white/5 backdrop-blur-md p-8 border border-white/10 rounded-sm space-y-8">
                            ...
                            <div class="flex gap-4 items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-400">ご購入確定後、技巧 -GIKO-より商品をお客様のご住所へ発送いたします。</p>
                                </div>
                            </div>
                                    ...
                                    <div class="space-y-3">
                                        <div class="bg-black/40 border border-white/10 p-4 rounded-sm">
                                            <div class="flex items-center gap-2 mb-1">
                                                ...
                                                <span class="font-bold text-sm text-white">技巧 -GIKO-に買取を依頼する場合（追加費用なし）</span>
                                            </div>
                                            <p class="text-xs text-gray-400 ml-6">取り外した旧パーツを技巧 -GIKO-へご返送いただければ、追加費用はかかりません。</p>
                                        </div>
                                        <div class="bg-black/40 border border-white/10 p-4 rounded-sm">
                                            <div class="flex items-center gap-2 mb-1">
        ...
        <div class="bg-gray-900 border border-primary/30 rounded-sm max-w-md w-full shadow-2xl overflow-hidden transform transition-all">
            ...
            <div class="p-8 space-y-6">
                <p class="text-sm text-gray-300 leading-relaxed">
                    脱着作業をご自身で行うことが難しい場合、技巧 -GIKO-にて作業を承ります。<br>
                    以下の連絡先までお問い合わせください。
                </p>
