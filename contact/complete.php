...
<head>
    ...
    <style> body { font-family: 'Noto Sans JP', sans-serif; background-color: #000; color: #fff; } .font-en { font-family: 'Montserrat', sans-serif; } </style>
</head>

<body class="bg-black text-white antialiased flex items-center justify-center min-h-screen">

    <div class="text-center p-8 max-w-lg">
        <div class="w-24 h-24 bg-primary rounded-full flex items-center justify-center text-black text-4xl mx-auto mb-8 shadow-lg shadow-primary/30">
        ...
        <a href="../index.html" class="inline-block border border-white/20 px-10 py-4 hover:bg-white hover:text-black transition-colors rounded-sm text-sm tracking-widest font-en">
            TOPに戻る
        </a>
    </div>
